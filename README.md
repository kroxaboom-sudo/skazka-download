...
Проверено на HOSTKEY: queue/persistence/recovery/planner/batch self-test — PASS; HTTP redirect/resume/hooks/rejection self-test — PASS; source-worker registry self-test — PASS; host-throttle self-test — PASS; transfer-rate-meter self-test — PASS; `:download-android:assembleDebug` — PASS; `:download-android:lintDebug` — PASS.
...
Verified on HOSTKEY: queue/persistence/recovery/planner/batch self-test — PASS; HTTP redirect/resume/hooks/rejection self-test — PASS; source-worker registry self-test — PASS; host-throttle self-test — PASS; transfer-rate-meter self-test — PASS; `:download-android:assembleDebug` — PASS; `:download-android:lintDebug` — PASS.
